...
public class Reserva extends JFrame{
    ...
    public Reserva(){
        ...
        lblNoches.setForeground(Color.white);
        lblHabDis.setFont(new Font("dialog", 1, 28));
        lblHabDis.setForeground(Color.white);
        ...
        btnRes.setBounds(220, 615, 150, 35);
        btnRes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnResActionPerformed(evt);
            }
        });
        btnVol.setBounds(520, 615, 150, 35);
    ...
    public void btnResActionPerformed(java.awt.event.ActionEvent evt) {
        ReservaIngresoDatos ri = new ReservaIngresoDatos();
